...
import 'package:natureslink/chatApp/call.dart';
import 'package:natureslink/chatApp/index.dart';
...
class ChatScreen extends StatefulWidget {
  ...
  State<ChatScreen> createState() =>
      _ChatScreenState(friendUid, friendName, currentUserName);
}
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  var currentUserId = globals.objuidString;
                          ...
                          child: ListView(
                            ...
                            children: snapshot.data!.docs.map(
                              (DocumentSnapshot document) {
                                ...
                                // print(data['createdOn'].toDate().day);

                                if (DateTime.now().day ==
                                    data['createdOn'].toDate().day) {
                                print(DateTime.now().minute);
                                print(data['createdOn'].toDate().minute);
                                if (DateTime.now().minute ==
                                    data['createdOn'].toDate().minute) {
